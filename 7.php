...
<body>
    <!-- Виведення шапки сайту -->
     <p class='product_text' align="center" ><img  class = "product_img" src='img/png-transparent-computer-icons-magazine-windows-95-icon-logo-sign-signage.png' >7. План роботи керівника на семестр навчального року </p>
            ...
            <th>Відмітка</th>
                ...
                ?>
                    <tr >
                        ...
                        <?php  if($rozdil[3] == "") {?>
                          <form action="vendor/create_vid_7.php" method="post">
                            <input  type="hidden" name="Id" value="<?= $rozdil[0] ?>">
                            <input type="checkbox" name="a" value="Виконано">
                            <button type="submit" class="btn-buy">Ок</form>
                    <?php } if($rozdil[1] != "") {?>
                        <?= $rozdil[3] ?>
                    <?php } ?>
...
<div align="center"><br><form action="7new.php" method="post">
