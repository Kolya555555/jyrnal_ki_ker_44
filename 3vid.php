...
<body>
    ...
    <?php $k=$rozdil['Id']%8;
    if($k == 0) {?>
<h2 align="center" >Відвідування студентів за 8 Семестр </h2>
<?php } else {?>
<h2 align="center" >Відвідування студентів за <?= $k ?> Семестр </h2> <?php } ?>
<h2 align="center" > <?= $tip ?></h2>
<!-- Виведення головного вмісту сторінки -->
<div align="center">
        <div>
            <p><img src='vendor/three_rozdil/<?= $rozdil['Vid'] ?>' ></p>
        </div>
</div>
</body>
</html>