...
<br><div class="vis">
<div>
<h2 align="center">Не активні користувачі системи</h2>
        <?php
        /*Делаем выборку строк і преобразовывем полученные данные в нормальный массив*/
        $request = mysqli_query($connect, "SELECT * FROM `request` WHERE `request`.`dozvil` = 'Неактивний'");
            ...
            foreach ($request as $request) {
                ?>
                    <tr align="center">
                        ...
                        <td><?= $request[7] ?></td>
                        <td><a style="color: red;" href="vendor/delete.php?id=<?= $request[0] ?>">Видалити</a></td>
                        <td><a style="color: blue;" href="vendor/ok.php?id=<?= $request[0] ?>">Активувати</a></td>
                     </tr>
