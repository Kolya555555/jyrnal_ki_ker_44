...
$student = mysqli_query($connect, "SELECT * FROM `student` ");
 ...
 $grup = $_POST['grup'];?>
 <br><div class="vis">
<h2 align="center">Введіть опис плану <b><?php echo $grup; ?> </b></h2>
    <div align="center">
        <form id="number" action="vendor/create_new_7.php" method="post">
        ...
        <button type="submit" class="btn-buy">Добавити запис
    </form></div><br></div>
</body>
</html>
